...
#initiating tradingview handler to get the recomendation for BANKNIFTY software for 15 min interval
ssw = TA_Handler(
    symbol="BANKNIFTY",
    screener="india",
    exchange="NSE",
...
while True:
    ...
    if(current_time >= "09:15:00" and current_time < "15:30:00"):
        ...
        if ( RSI >= 30 and RSI <= 70 and EMA == "BUY" ):
            if (last_order=="sell"):
                print("Buying 1 stock of BANKNIFTY")
                last_order="buy"
                print(last_order)
                print(sold_before)
                #buy 1 stock of banknifty
                ...
                while True:
                    ...
                    if((RSI >= 30 and EMA == "SELL") or (float(current_price) >= take_profit) or (float(current_price) <= take_loss)):
                        #sell the stock
                        print("Selling 1 stock of BANKNIFTY")
                        last_order="sell"
                        print(last_order)
                        #sell 1 stock of banknifty 
            ...
            if ( last_order == "sell"):
                print("selling stock of BANKNIFTY")
                driver.find_element(By.XPATH,"//body[1]/div[2]/div[8]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]").click()
                time.sleep(2)
                driver.find_element(By.XPATH,"//button[1]/div[1]/span[2]").click            ()
                current_price = driver.find_element(By.XPATH,"//div[2]/div[8]/div[1]/div/div/div[1]/div[2]/div/div[2]/div[2]/div").text
